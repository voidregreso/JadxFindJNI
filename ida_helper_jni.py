...
class JNIHelperPlugin(idaapi.plugin_t):
    ...
    def run(self, arg):
        """
        :param arg: Entero, un valor distinto de cero habilita la función de ejecución automática para el 
        modo de procesamiento por lotes IDA (sin interfaz gráfica de usuario). El valor predeterminado es 0.
        """
        log("plugin run")
